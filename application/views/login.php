...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <style>
		...
		#inputs input:focus
		{
		    ...
		    border-color: #009900;
		    outline: none;
		    -moz-box-shadow: 0 0 0 1px #009900 inset;
		    -webkit-box-shadow: 0 0 0 1px #009900 inset;
		...
		{		
		    ...
		    background-image: -webkit-gradient(linear, left top, left bottom, from(#009900), to(#009900));
		    ...
		    background-image: linear-gradient(top, #009900, #009900);
    ...
    <body>
        	<form id="login" action="<?php echo URL::base(); ?>login/index" method="POST">
                
                <h1>
                	BIENVENIDO    
                </h1>
                <fieldset id="inputs">
                    <input id="username" type="text" placeholder="Correo" autofocus  name="email" >   
